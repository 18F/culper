...
require('jest-snapshot');const initializeSnapshotState = _require2.initializeSnapshotState,addSerializer = _require2.addSerializer;var _require3 =
...
function addAssertionErrors(result) {var _getState2 =
  getState();const assertionCalls = _getState2.assertionCalls,assertionsExpected = _getState2.assertionsExpected;
  setState({
    assertionCalls: 0,
