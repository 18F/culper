...
describe('The title section', () => {
  ...
  it('can handle title 1 deep', () => {
    ...
    const component = mount(<Provider store={store}><SectionTitle /></Provider>)
    expect(component.find('h1').length).toEqual(1)
    expect(component.find('h1').text()).toEqual('Investigative and criminal history')
  })
  ...
  it('can handle title 2 deep', () => {
    ...
    const component = mount(<Provider store={store}><SectionTitle /></Provider>)
    expect(component.find('h1').length).toEqual(1)
    expect(component.find('h1').text()).toEqual('Investigative and criminal history > Use of information technology systems')
  })
  ...
  it('can handle title 3 deep', () => {
    ...
    const component = mount(<Provider store={store}><SectionTitle /></Provider>)
    expect(component.find('h1').length).toEqual(1)
    expect(component.find('h1').text()).toEqual('Investigative and criminal history > Use of information technology systems > Unauthorized access')
  })
})
