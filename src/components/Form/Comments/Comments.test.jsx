...
describe('The comments component', () => {
  it('textarea hidden if no value', () => {
    const component = mount(<Comments name="comments" label="Optional comments" value="" />)
    expect(component.find('textarea').length).toEqual(0)
  })

  it('textarea visible if given a value', () => {
    const component = mount(<Comments name="comments" label="Optional comments" value="test" />)
