    ...
    case 'POSTOFFICE':
      return (
        <div className="address-suggestion">
          <div>
            <HighlightedField
              new={suggestion.Street || suggestion.street}
              current={current.street}
            />
          </div>
          <div>
            <HighlightedField
              new={suggestion.Street2 || suggestion.street2}
              current={current.street2}
            />
          </div>
          <div>
            <HighlightedField
              new={suggestion.City || suggestion.city}
              current={current.city}
            />
            ,{' '}
            <HighlightedField
              new={suggestion.State || suggestion.state}
              current={current.state}
            />{' '}
            <HighlightedField
              new={suggestion.Zipcode || suggestion.zipcode}
      ...
      return (
        <div className="address-suggestion">
          ...
          <div>
            ...
            ,{' '}
            <HighlightedField
              new={suggestion.Country || suggestion.country}
              current={country}
            />
          </div>
        </div>
...
export function HighlightedField(props) {
  ...
  if (updated.toUpperCase() !== current.toUpperCase()) {
    return <span className="highlight">{updated}</span>
  }
