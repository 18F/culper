  ...
  render () {
    return (
      <Dropdown name={this.props.name}
        ...
        <option value="Cote d'Ivoire">Ivoire</option>
        ...
        <option value="Etorofu, Habomai, Kunashiri And Shikotan Islands">Etorofu, Habomai, Kunashiri And Shikotan Islands</option>
