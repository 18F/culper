...
describe('The text component', () => {
  it('renders appropriately with an error', () => {
    ...
    const component = shallow(<Text name={expected.name} label={expected.label} help={expected.help} error={expected.error} focus={expected.focus} valid={expected.valid} />)
