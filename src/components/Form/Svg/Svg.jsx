      ...
      <svg
        ...
        <g>
          <path
            ...
            d="M13.59,3.63c0.65,1.12,0.98,2.34,0.98,3.66s-0.33,2.54-0.98,3.66c-0.65,1.12-1.54,2-2.65,2.65
  ...
  '/img/bald.svg': props => {
    return (
      <svg
        ...
        <path
          d="M11.571,30.953h-1.328L10.04,30.9c-0.377-0.188-0.754-0.378-1.226-0.566l0.371-0.928
        ...
        />
        <path
          d="M6.4,28.932c-0.853-0.538-1.63-1.108-2.31-1.696l0.653-0.756c0.643,0.555,1.379,1.095,2.189,1.606L6.4,28.932
        ...
        />
        <path
          d="M7.855,1.963C7.666,1.491,7.478,1.018,7.289,0.64L6.928-0.083h0.927l0.203,0.053
                 c0.381,0.19,0.757,0.379,1.226,0.566L8.912,1.464C8.838,1.435,8.767,1.405,8.697,1.376C8.726,1.448,8.755,1.52,8.784,1.592
                 L7.855,1.963z"
        />
        <path
          d="M8.667,27.461C8.556,27.004,8.5,26.539,8.5,26.079c0-0.576,0.104-1.134,0.31-1.656l0.931,0.365
  ...
  '/img/question.svg': props => {
    return (
      <svg
        ...
        <path
          d="M15.43,34.25C6.91,34.25,0,27.34,0,18.82C0,10.3,6.91,3.39,15.43,3.39s15.43,6.91,15.43,15.43
  ...
  '/img/eye.svg': props => {
    return (
      <svg
        ...
        <path
          d="M35.61,21.49c-3.7,6.09-10.47,10.19-17.6,10.19S4.1,27.56,0.4,21.49C0.16,21.07,0,20.61,0,20.11
  ...
  '/img/female.svg': props => {
    return (
      <svg
        ...
        <path
          d="M50.81,25.4C50.81,11.37,39.43,0,25.4,0S0,11.37,0,25.4c0,12.32,8.77,22.59,20.4,24.91v9.09h-9.79v10h9.79v9.79
  ...
  '/img/male.svg': props => {
    return (
      <svg
        ...
        viewBox="-10 -10 80 80">
        <path
          d="M62.77,0.12V0H37.69v10h8.64l-6.4,6.4c-4.35-3.04-9.43-4.56-14.52-4.56c-6.5,0-13,2.48-17.96,7.44
  ...
  '/img/neighbor-icon.svg': props => {
    return (
      <svg
        ...
        tabIndex="-1"
        focusable="false"
        viewBox="0 0 74.94 28.35">
        <path
          d="M30.54,9.79V0.78c0-0.4-0.31-0.71-0.71-0.71h-4.24c-0.4,0-0.71,0.31-0.71,0.71v4.31l-5.39-4.51
        ...
        />
        <path
          d="M17.81,5.73L5.11,16.2c0,0.05-0.02,0.09-0.02,0.13v10.61c0,0.77,0.64,1.41,1.41,1.41h8.49v-8.49h5.66v8.49
                 h8.49c0.77,0,1.41-0.64,1.41-1.41V16.33c0-0.04,0-0.09-0.02-0.13L17.81,5.73z"
        />
        <path
          d="M57.12,5.73L44.42,16.2c0,0.05-0.02,0.09-0.02,0.13v10.61c0,0.77,0.64,1.41,1.41,1.41h8.49v-8.49h5.66v8.49
                 h8.49c0.77,0,1.41-0.64,1.41-1.41V16.33c0-0.04,0-0.09-0.02-0.13L57.12,5.73z"
        />
        <path
          d="M74.69,13.82l-4.84-4.02V0.78c0-0.4-0.31-0.71-0.71-0.71H64.9c-0.4,0-0.71,0.31-0.71,0.71v4.31L58.8,0.58
  ...
  '/img/friend-icon.svg': props => {
    return (
      <svg
        ...
        tabIndex="-1"
        focusable="false"
        viewBox="0 0 44.33 34.84">
        <path
          d="M17.42,25.33c-1.51,0-2.97-0.15-4.35-0.4c-2.05,1.46-4.38,2.52-6.88,3.17c-0.67,0.17-1.39,0.3-2.13,0.4
  ...
  '/img/landlord-icon.svg': props => {
    return (
      <svg
        ...
        tabIndex="-1"
        focusable="false"
        viewBox="0 0 29.56 37.62">
        <path
          d="M29.56,1.34v34.94c0,0.73-0.61,1.34-1.34,1.34H1.34C0.61,37.62,0,37.01,0,36.28V1.34C0,0.61,0.61,0,1.34,0
  ...
  '/img/business-associate-icon.svg': props => {
    return (
      <svg
        ...
        tabIndex="-1"
        focusable="false"
        viewBox="0 0 40.05 34.33">
        <path
          d="M40.05,17.88H0V9.3c0-1.97,1.61-3.58,3.58-3.58h7.87V2.15C11.44,0.96,12.4,0,13.59,0h12.87
  ...
  '/img/other-icon.svg': props => {
    return (
      <svg
        ...
        <path
          d="M18.31,36.62C8.2,36.62,0,28.42,0,18.31C0,8.2,8.2,0,18.31,0s18.31,8.2,18.31,18.31
  ...
  '/img/checkmark.svg': props => {
    return (
      <svg
        ...
        tabIndex="-1"
        focusable="false"
        viewBox="0 0 15.95 15.96"
        enableBackground=":new 0 0 15.95 15.96;">
        <path
          d="M7.98,15.96C3.57,15.96,0,12.39,0,7.98C0,3.57,3.57,0,7.98,0s7.98,3.57,7.98,7.98
  ...
  '/img/exclamation.svg': props => {
    return (
      <svg
        ...
        enableBackground=":new 0 0 15.95 15.95;">
        <path
          d="M15.95,7.97c0,4.4-3.57,7.97-7.97,7.97S0,12.38,0,7.97S3.57,0,7.97,0S15.95,3.57,15.95,7.97z M9.47,2.93
  ...
  '/img/submit-error.svg': props => {
    return (
      <svg
        ...
        focusable="false"
        viewBox="0 0 15.9 16"
        enableBackground=":new 0 0 15.9 16;">
        <path
          className="st2"
          d="M15.9,8c0,4.4-3.6,8-7.9,8S0,12.4,0,8s3.6-8,7.9-8S15.9,3.6,15.9,8z M9.4,3c0-0.2,0-0.3-0.3-0.3H6.8
  ...
  '/img/schoolmate.svg': props => {
    return (
      <svg
        ...
        tabIndex="-1"
        focusable="false"
        viewBox="0 0 52.3 41.62">
        <path
          fill=""
          d="M51.72,14.24l-25.29,7.95c-0.09,0.02-0.16,0.02-0.23,0.02s-0.13,0-0.23-0.02l-14.72-4.65
