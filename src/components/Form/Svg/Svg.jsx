...
const dust = {
  '/img/info.svg': () => {
    return (
      <svg width="14.57px" height="14.57px" viewBox="0 0 14.57 14.57">
        <g>
  ...
  '/img/checkmark.svg': () => {
    return (
      <svg viewBox="0 0 15.95 15.96" enableBackground=":new 0 0 15.95 15.96;">
        <path class="st0" d="M7.98,15.96C3.57,15.96,0,12.39,0,7.98C0,3.57,3.57,0,7.98,0s7.98,3.57,7.98,7.98
  ...
  '/img/exclamation.svg': () => {
    return (
      <svg viewBox="0 0 15.95 15.95" enableBackground=":new 0 0 15.95 15.95;">
