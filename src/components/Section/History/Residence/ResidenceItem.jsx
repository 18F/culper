...
import { ValidationElement, DateRange, Text, RadioGroup, Radio,
         Field, Location, Show, Name, DateControl, CheckboxGroup,
         Checkbox, Svg, Telephone, NotApplicable, Email } from '../../../Form'
...
export default class ResidenceItem extends ValidationElement {
  constructor (props) {
    ...
    this.updateReferenceRelationshipComments = this.updateReferenceRelationshipComments.bind(this)
    this.updateReferenceRelationship = this.updateReferenceRelationship.bind(this)
    this.updateReferenceRelationshipOther = this.updateReferenceRelationshipOther.bind(this)
    this.updateReferencePhoneEvening = this.updateReferencePhoneEvening.bind(this)
        ...
        <Show when={withinThreeYears(from, to, dates.present)}>
          <div>
            ...
            <div className="reference">
              ...
              <Field title={i18n.t('reference.heading.contact')}
              ...
              <Field title={i18n.t('reference.heading.relationship')}
                     comments={true}
                ...
                <CheckboxGroup className="relationship option-list eapp-extend-labels"
                               required={this.props.required}
                               onError={this.props.onError}
                               selectedValues={(this.props.ReferenceRelationship || {}).values || []}>
                ...
                <Show when={((this.props.ReferenceRelationship || {}).values || []).some(x => { return x === 'Other' })}>
                  <Text name="ReferenceRelationshipOther"
              ...
              <Field title={i18n.t('reference.heading.phone.evening')}
                     ...
                     adjustFor="telephone"
                     scrollIntoView={this.props.scrollIntoView}>
                <Telephone name="ReferencePhoneEvening"
              ...
              <Field title={i18n.t('reference.heading.phone.day')}
                     ...
                     adjustFor="telephone"
                     scrollIntoView={this.props.scrollIntoView}>
                <Telephone name="ReferencePhoneDay"
              ...
              <Field title={i18n.t('reference.heading.phone.mobile')}
                     ...
                     adjustFor="telephone"
                     scrollIntoView={this.props.scrollIntoView}>
                <Telephone name="ReferencePhoneMobile"
