...
import { ValidationElement, Branch, Collection, Comments, DateRange, Reference, Text, RadioGroup, Radio, Help, HelpIcon, Address, Svg, Show } from '../../../Form'
    ...
    return (
      <div className="education">
        <Branch name="branch_school"
                ...
                help="history.education.help.attendence"
                label={i18n.t('history.education.label.attendance')}
                onUpdate={this.updateBranch}
                >
        </Branch>
        <Show when={this.state.HasAttended === 'Yes'}>
