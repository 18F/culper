...
describe('The legal associations advocating in terrorism item component', () => {
  it('can select "yes"', () => {
    ...
    component.find('.legal-associations-advocating-reasons textarea').simulate('change')
    component.find('.legal-associations-advocating-dates .from .year input').simulate('change')
