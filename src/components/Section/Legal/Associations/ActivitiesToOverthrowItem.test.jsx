...
describe('The legal associations engaged in terrorism item component', () => {
  it('can select "yes"', () => {
    ...
    component.find('.legal-associations-activities-reasons textarea').simulate('change')
    component.find('.legal-associations-activities-dates .from .year input').simulate('change')
