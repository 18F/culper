...
describe('The legal associations engaged in terrorism item component', () => {
  it('can select "yes"', () => {
    ...
    component.find('.legal-associations-engaged-reasons textarea').simulate('change')
    component.find('.legal-associations-engaged-dates .from .year input').simulate('change')
