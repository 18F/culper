...
export default class ManipulatingItem extends ValidationElement {
  ...
  render() {
    return (
      <div>
        <Field
          title={i18n.t('legal.technology.manipulating.heading.date')}
        ...
        <Field
          title={i18n.t('legal.technology.manipulating.heading.incident')}
          adjustFor="textarea"
          scrollIntoView={this.props.scrollIntoView}>
          <Textarea
            name="Incident"
        ...
        <Field
          title={i18n.t('legal.technology.manipulating.heading.location')}
          optional={true}
        ...
        <Field
          title={i18n.t('legal.technology.manipulating.heading.action')}
          adjustFor="textarea"
          scrollIntoView={this.props.scrollIntoView}>
          <Textarea
            name="Action"
