export const sectionData = (section, subsection, application = {}) => {
  ...
  case 'identification/birthdate':
    return [
      { path: 'identification/birthdate', data: wrap(application.Identification).ApplicantBirthDate }
    ]
  case 'identification/birthplace':
    return [
      { path: 'identification/birthplace', data: wrap(application.Identification).ApplicantBirthPlace }
    ]
  case 'identification/contacts':
    return [
      { path: 'identification/contacts', data: wrap(application.Identification).Contacts }
    ]
  ...
  case 'financial/bankruptcy':
    return [
      { path: 'financial/bankruptcy', data: wrap(application.Financial).Bankruptcy }
    ]
  case 'financial/gambling':
    return [
      { path: 'financial/gambling', data: wrap(application.Financial).Gambling }
    ]
  ...
  case 'foreign/activities/benefits':
    return [
      { path: 'foreign/activities/benefits', data: wrap(application.Foreign).BenefitActivity }
    ]
  case 'foreign/activities/direct':
    return [
      { path: 'foreign/activities/direct', data: wrap(application.Foreign).DirectActivity }
    ]
  case 'foreign/activities/indirect':
    return [
      { path: 'foreign/activities/indirect', data: wrap(application.Foreign).IndirectActivity }
    ]
  case 'foreign/activities/realestate':
    return [
      { path: 'foreign/activities/realestate', data: wrap(application.Foreign).RealEstateActivity }
    ]
  case 'foreign/activities/support':
    return [
      { path: 'foreign/activities/support', data: wrap(application.Foreign).Support }
    ]
  case 'foreign/business/advice':
    return [
      { path: 'foreign/business/advice', data: wrap(application.Foreign).Advice }
    ]
  case 'foreign/business/conferences':
    return [
      { path: 'foreign/business/conferences', data: wrap(application.Foreign).Conferences }
    ]
  case 'foreign/business/contact':
    return [
      { path: 'foreign/business/contact', data: wrap(application.Foreign).Contact }
    ]
  case 'foreign/business/employment':
    return [
      { path: 'foreign/business/employment', data: wrap(application.Foreign).Employment }
    ]
  case 'foreign/business/family':
    return [
      { path: 'foreign/business/family', data: wrap(application.Foreign).Family }
    ]
  case 'foreign/business/political':
    return [
      { path: 'foreign/business/political', data: wrap(application.Foreign).Political }
    ]
  case 'foreign/business/sponsorship':
    return [
      { path: 'foreign/business/sponsorship', data: wrap(application.Foreign).Sponsorship }
    ]
  case 'foreign/business/ventures':
    return [
      { path: 'foreign/business/ventures', data: wrap(application.Foreign).Ventures }
    ]
  ...
  case 'substance/alcohol/additional':
    return [
      { path: 'substance/alcohol/additional', data: wrap(application.Substance).ReceivedCounselings }
    ]
  case 'substance/alcohol/negative':
    return [
      { path: 'substance/alcohol/negative', data: wrap(application.Substance).NegativeImpacts }
    ]
  case 'substance/alcohol/ordered':
    return [
      { path: 'substance/alcohol/ordered', data: wrap(application.Substance).OrderedCounselings }
    ]
  case 'substance/alcohol/voluntary':
    return [
      { path: 'substance/alcohol/voluntary', data: wrap(application.Substance).VoluntaryCounselings }
    ]
  case 'substance/drugs/clearance':
    return [
      { path: 'substance/drugs/clearance', data: wrap(application.Substance).DrugClearanceUses }
    ]
  case 'substance/drugs/misuse':
    return [
      { path: 'substance/drugs/misuse', data: wrap(application.Substance).PrescriptionUses }
    ]
  case 'substance/drugs/ordered':
    return [
      { path: 'substance/drugs/ordered', data: wrap(application.Substance).OrderedTreatments }
    ]
  ...
  case 'legal/associations/activities-to-overthrow':
    return [
      { path: 'legal/associations/activities-to-overthrow', data: wrap(application.Legal).ActivitiesToOverthrow }
    ]
  case 'legal/associations/advocating':
    return [
      { path: 'legal/associations/advocating', data: wrap(application.Legal).Advocating }
    ]
  case 'legal/associations/engaged-in-terrorism':
    return [
      { path: 'legal/associations/engaged-in-terrorism', data: wrap(application.Legal).EngagedInTerrorism }
    ]
  case 'legal/associations/membership-overthrow':
    return [
      { path: 'legal/associations/membership-overthrow', data: wrap(application.Legal).MembershipOverthrow }
    ]
  case 'legal/associations/membership-violence-or-force':
    return [
      { path: 'legal/associations/membership-violence-or-force', data: wrap(application.Legal).MembershipViolence }
    ]
  case 'legal/associations/terrorism-association':
    return [
      { path: 'legal/associations/terrorism-association', data: wrap(application.Legal).TerrorismAssociation }
    ]
  case 'legal/associations/terrorist-organization':
    return [
      { path: 'legal/associations/terrorist-organization', data: wrap(application.Legal).TerroristOrganization }
    ]
  case 'legal/court':
    return [
      { path: 'legal/court', data: wrap(application.Legal).NonCriminalCourtActions }
    ]
  case 'legal/investigations/debarred':
    return [
      { path: 'legal/investigations/debarred', data: wrap(application.Legal).Debarred }
    ]
  case 'legal/investigations/history':
    return [
      { path: 'legal/investigations/history', data: wrap(application.Legal).History }
    ]
  case 'legal/investigations/revoked':
    return [
      { path: 'legal/investigations/revoked', data: wrap(application.Legal).Revoked }
    ]
  ...
  case 'psychological/competence':
    return [
      { path: 'psychological/competence', data: wrap(application.Psychological).Competence }
    ]
  ...
  case 'submission/releases':
    return [
      { path: 'submission/releases', data: wrap(application.Submission).Releases }
    ]
  }
