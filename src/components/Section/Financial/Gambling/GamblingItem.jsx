  ...
  render() {
    return (
      <div className="gambling-item">
        <Field
          title={i18n.t('financial.gambling.heading.dates')}
        ...
        <Field
          title={i18n.t('financial.gambling.heading.losses')}
          scrollIntoView={this.props.scrollIntoView}>
          <Currency
            name="Losses"
            {...this.props.Losses}
        ...
        <Field
          title={i18n.t('financial.gambling.heading.description')}
          scrollIntoView={this.props.scrollIntoView}
        ...
        <Field
          title={i18n.t('financial.gambling.heading.actions')}
          scrollIntoView={this.props.scrollIntoView}
