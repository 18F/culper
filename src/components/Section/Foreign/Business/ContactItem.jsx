  ...
  render() {
    return (
      <div className="foreign-business-contact-item">
        <Field
          title={i18n.t('foreign.business.contact.heading.name')}
          optional={true}
        ...
        <Field
          title={i18n.t('foreign.business.contact.heading.location')}
          scrollIntoView={this.props.scrollIntoView}>
          <Location
            name="Location"
            {...this.props.Location}
        ...
        <Field
          title={i18n.t('foreign.business.contact.heading.date')}
        ...
        <Field
          title={i18n.t('foreign.business.contact.heading.governments')}
        ...
        <Field
          title={i18n.t('foreign.business.contact.heading.establishment')}
          adjustFor="textarea"
          scrollIntoView={this.props.scrollIntoView}>
          <Textarea
            name="Establishment"
        ...
        <Field
          title={i18n.t('foreign.business.contact.heading.representatives')}
          adjustFor="textarea"
          scrollIntoView={this.props.scrollIntoView}>
          <Textarea
        ...
        <Field
          title={i18n.t('foreign.business.contact.heading.purpose')}
          adjustFor="textarea"
          scrollIntoView={this.props.scrollIntoView}>
          <Textarea
            name="Purpose"
