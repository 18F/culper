...
export default class SponsorshipItem extends ValidationElement {
  constructor (props) {
    ...
    this.updateOrganizationNotApplicable = this.updateOrganizationNotApplicable.bind(this)
    this.updateOrganization = this.updateOrganization.bind(this)
    this.updateOrganizationAddressNotApplicable = this.updateOrganizationAddressNotApplicable.bind(this)
  ...
  update (queue) {
    this.props.onUpdate({
      ...
      OrganizationAddressNotApplicable: this.props.OrganizationAddressNotApplicable,
