...
describe('The RealEstateInterest component', () => {
  ...
  it('Performs updates', () => {
    ...
    const component = mount(<RealEstateInterest onUpdate={onUpdate} InterestTypes={interestTypes} />)
    expect(component.find('.interest').length).toBe(1)
    ...
    component.find('.sold input[name="month"]').simulate('change', { target: { value: '2' } })
    component.find('.sold input[name="year"]').simulate('change', { target: { value: '2010' } })
    component.find('.not-applicable input[name="SoldNotApplicable"]').simulate('change')
