  ...
  render() {
    ...
    return (
      <div className="co-owner">
        <Field
          title={i18n.t(`foreign.${prefix}.heading.name`)}
          optional={true}
        ...
        <Field
          title={i18n.t(`foreign.${prefix}.heading.address`)}
          optional={true}
          adjustFor="address"
          shrink={true}
          scrollIntoView={this.props.scrollIntoView}>
        ...
        <Field
          title={i18n.t(`foreign.${prefix}.heading.countries`)}
        ...
        <Field
          title={i18n.t(`foreign.${prefix}.heading.relationshipNature`)}
          scrollIntoView={this.props.scrollIntoView}>
          <Textarea
