  ...
  render() {
    return (
      <div className="support-item">
        <Field
          title={i18n.t('foreign.activities.support.heading.name')}
          optional={true}
        ...
        <Field
          title={i18n.t('foreign.activities.support.heading.address')}
          optional={true}
          adjustFor="address"
          scrollIntoView={this.props.scrollIntoView}>
          <Location
        ...
        <Field
          title={i18n.t('foreign.activities.support.heading.relationship')}
          adjustFor="textarea"
          scrollIntoView={this.props.scrollIntoView}>
          <Textarea
            name="Relationship"
        ...
        <Field
          title={i18n.t('foreign.activities.support.heading.amount')}
        ...
        <Field
          title={i18n.t('foreign.activities.support.heading.frequency')}
          adjustFor="text"
          scrollIntoView={this.props.scrollIntoView}>
          <Text
            name="Frequency"
        ...
        <Field
          title={i18n.t('foreign.activities.support.heading.citizenship')}
