...
export default class DrugInvolvement extends ValidationElement {
  constructor(props) {
    ...
    this.updateInvolvementWhileEmployed = this.updateInvolvementWhileEmployed.bind(
      this
    )
    this.updateInvolvementWithClearance = this.updateInvolvementWithClearance.bind(
      this
    )
      ...
      <div className="drug-involvement">
        ...
        <Field
          ...
          <DateControl
            ...
            minDateEqualTo={true}
            maxDate={(this.props.FirstInvolvement || {}).date}
            showEstimated={false}
