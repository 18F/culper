  ...
  render() {
    return (
      <div
        ...
        <h1 className="section-header">{i18n.t('substance.destination.police.additional')}</h1>
        <Branch
        ...
        <Show when={this.props.ReceivedTreatment.value === 'Yes'}>
          <Accordion
            ...
            description={i18n.t(
              'substance.alcohol.receivedCounseling.collection.description'
            )}
            appendTitle={i18n.t(
              'substance.alcohol.receivedCounseling.collection.appendTitle'
            )}
            appendLabel={i18n.t(
              'substance.alcohol.receivedCounseling.collection.appendLabel'
            )}
            required={this.props.required}
            scrollIntoView={this.props.scrollIntoView}>
            <ReceivedCounseling
