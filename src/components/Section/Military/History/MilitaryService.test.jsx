...
describe('The military service component', () => {
  ...
  it('trigger updates when chaging values', () => {
    ...
    component.find('.dates .datecontrol.from .month input').simulate('change', { target: { value: '1' } })
    component.find('.dates .datecontrol.from .day input').simulate('change', { target: { value: '1' } })
    component.find('.dates .datecontrol.from .year input').simulate('change', { target: { value: '2001' } })
    component.find('.dates .datecontrol.to .month input').simulate('change', { target: { value: '1' } })
    component.find('.dates .datecontrol.to .day input').simulate('change', { target: { value: '1' } })
    component.find('.dates .datecontrol.to .year input').simulate('change', { target: { value: '2005' } })
    component.find('.discharged .yes input').simulate('change')
    component.find('.discharge-type-other input').simulate('change')
    component.find('.discharge-type-otherex input').simulate('change', { target: { value: 'Something I have not heard of' } })
    component.find('.discharge-reason input').simulate('change', { target: { value: 'Some reason' } })
    component.find('.discharge-date .month input').simulate('change', { target: { value: '1' } })
    component.find('.discharge-date .year input').simulate('change', { target: { value: '2005' } })
