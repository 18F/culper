...
export const financial = {
  ...
  taxes: {
    title:
      'In the last {{yearsString}} ({{years}}) years have you failed to file or pay Federal, state, or other taxes when required by law or ordinance?',
    heading: {
    ...
    collection: {
      ...
      appendTitle:
        'Are there any other instances in the last {{yearsString}} ({{years}}) years where you failed to file or pay Federal, state, or other taxes when required by law or ordinance?',
  ...
  delinquent: {
    ...
    para: {
      ...
      alimony:
        '**In the last {{yearsString}} ({{years}}) years,** you have been delinquent on alimony or child support payments.',
      judgement:
        '**In the last {{yearsString}} ({{years}}) years,** you had a judgement entered against you. (Include financial obligations for which you were the sole debtor, as well as those for which you were a cosigner or guarantor).',
      lien:
        '**In the last {{yearsString}} ({{years}}) years,** you had a lien placed against your property for failing to pay taxes or other debts. (Include financial obligations for which you were the sole debtor, as well as those for which you were a cosigner or guarantor).',
      federal:
