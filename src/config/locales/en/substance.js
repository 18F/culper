export const substance = {
  ...
  destination: {
    ...
    'drugs/usage': 'Usage',
    'drugs/purchase': 'Purchase',
    'drugs/clearance': 'Security clearance position',
    'drugs/publicsafety': 'Public safety position',
    'drugs/misuse': 'Prescription drug misuse',
    'drugs/ordered': 'Mandatory counseling or treatment',
    'drugs/voluntary': 'Voluntary counseling or treatment',
    'alcohol/negative': 'Negative impact',
    'alcohol/ordered': 'Mandatory counseling or treatment',
    'alcohol/voluntary': 'Voluntary counseling or treatment',
    'alcohol/additional': 'Additional instances',
    police: {
      usage: 'Usage',
      negative: 'Negative impact',
      ordered: 'Mandatory counseling or treatment',
