...
export const psychological = {
  ...
  competence: {
    heading: {
      ...
      appealCourtName:
        'Provide the name of the higher court or administrative agency',
      appealCourtAddress:
    ...
    help: {
      ...
      courtAddress: {
        title:
          'Try looking up the court or agency name, this could help you find the address',
        message:
  ...
  diagnosis: {
    ...
    person: {
      ...
      help: {
        address: {
          title:
            'Try looking up their name, this could help you find the address',
          message:
            'If you can only find a phone number try calling and asking for the address.',
          note:
            'Acronyms: APO - Army Post Office, FPO - Fleet Post Office, DPO - Diplomatic Post Office.',
    ...
    facility: {
      ...
      help: {
        address: {
          title:
            'Try looking up the name, this could help you find the address.',
          message:
            'If you can only find a phone number try calling and asking for the address.',
          note:
            'Acronyms: APO - Army Post Office, FPO - Fleet Post Office, DPO - Diplomatic Post Office.',
  ...
  diagnoses: {
    ...
    collection: {
      ...
      appendTitle:
        'Do you have an additional instance where you EVER had been diagnosed by a physician or other health professional (for example, a psychiatrist, psychologist, licensed clinical social worker, or nurse practitioner) with psychotic disorder, schizophrenia, schizoaffective disorder, delusional disorder, bipolar mood disorder, borderline personality disorder, or antisocial personality disorder?',
      appendMessage:
        'Health professional examples: a psychiatrist, psychologist, licensed clinical social worker, or nurse practitioner.',
    ...
    person: {
      help: {
        ...
        address: {
          title:
            "Try looking up the health care professional's name, this could help you find the address",
          message:
            'If you can only find a phone number try calling and asking for the address.',
          note:
            'Acronyms: APO - Army Post Office, FPO - Fleet Post Office, DPO - Diplomatic Post Office.',
    ...
    diagnosis: {
      ...
      person: {
        ...
        help: {
          ...
          name: {
            title:
              'Need help the name and number of this healthcare professional?',
            message:
      ...
      facility: {
        ...
        help: {
          address: {
            title:
              "Try looking up the treatment facility's name, this could help you find the address",
            message:
              'If you can only find a phone number try calling and asking for the address.',
            note:
              'Acronyms: APO - Army Post Office, FPO - Fleet Post Office, DPO - Diplomatic Post Office.',
