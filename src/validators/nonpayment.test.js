...
describe('nonpayment component validation', function () {
  ...
  it('validate court name', () => {
    ...
    tests.forEach(test => {
      expect(new NonpaymentItemValidator(test.state, null).validCourtName()).toBe(test.expected)
    })
  })
  ...
  it('validate court address', () => {
    ...
    tests.forEach(test => {
      expect(new NonpaymentItemValidator(test.state, null).validCourtAddress()).toBe(test.expected)
    })
  })
